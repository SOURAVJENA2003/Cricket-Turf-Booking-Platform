  ...
  return (
    <section id="pricing" className="bg-white border-b border-slate-100 py-20 md:py-28 relative overflow-hidden text-center font-sans">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center">
        ...
        <span className="text-xs font-semibold text-emerald-800 uppercase tracking-wider px-3.5 py-1 bg-emerald-100/40 border border-emerald-200/50 rounded-full mb-6">
          Fast Reservation
        </span>
